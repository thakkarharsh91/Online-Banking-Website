...
<div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><select name="destinationuseraccount"> <c:forEach var="item" items="${recepients}">
        <option> <c:out value="${item.accountnumber}"/>
        </option>
    </c:forEach></select></td>
    ...
    <tr>
      ...
      <td><select name="sourceuseraccounts"> <c:forEach var="item" items="${useraccounts}">
   ...
   <!-- <tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><button type="submit" id="submit" name="submit"> Transfer </button></td>
    </tr>
  </tbody>
</table>
