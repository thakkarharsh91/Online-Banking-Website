...
<body oncopy="return false" oncut="return false" onpaste="return false">
	...
	<form>
		...
		<table width="500" border="0">
			<tbody>
				<tr>
					<td><a href="${pageContext.request.contextPath}/VerifyExternalUser?${_csrf.parameterName}=${_csrf.token}">View Requests</a></td>
				</tr>
				<tr>
					<td><a href="${pageContext.request.contextPath}/modifyUs?${_csrf.parameterName}=${_csrf.token}">Manage User</a></td>
				</tr>
				<tr>
